...
%BAZE
%https://rdrr.io/cran/rTensor/man/faces_tnsr.html#heading-1
...
V projektu bova implementirali Googlov PageRank in njegovega starejšega brata Katzovo središčnost z uporabo potenčne metode. Na različnih grafih (tudi socialnih omrežjih) bova analizirali in primerjali, kako merjenji razvrstita vozlišča po pomembnosti. 
...
kar je power metoda za izračun lastnega vektorja.\\
...
Za nek $\alpha$, ki zadošča $0 \leq \alpha \leq 1$. Matrika $A$ je stolpčno stohastična. Razlaga naključnega sprehoda dodatnega rang-1 izraza je, da bo uporabnik na vsakem časovnem koraku skočil na naključno stran z verjetnostjo $1- \alpha$.
